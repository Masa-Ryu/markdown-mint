...
| R05         | Keyboard operations                              | Webview keymaps cover formatting, lists, tables, undo, redo, and navigation. The 0.0.3 browser pass verified list Enter, Tab, Shift+Tab, and Shift+Enter behavior. The host routes undo and redo through VS Code's native resource history; real operating system IME behavior remains a manual check.                                                                                                                                                                                                                                                                                                                                                                                                                                           |
