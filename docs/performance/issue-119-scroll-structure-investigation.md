...
- Measurement commit: `3c16c1f1412aa419662b463e4559a71b9d8722fa`
...
- Actual row/column handle clicks: pass at 0/50/100%; insertion controls: pass; resize wide→narrow→wide: pass.
- Selection reveal: Tab pass (C20), Shift+Tab pass, programmatic pass.
- Rightmost-cell edit/source/DOM probe: pass.

## Proxy Placement

- Bottom-only: PAC 5.7 ms, click 627.3 ms, full 1361.8 ms. It is not usable for a 2,000-row table without reaching the bottom.
- Active sticky: PAC 5.6 ms, click 620.7 ms, full 1363.2 ms. Visibility switches with the active large table; the proxy remains benchmark-only.
